...
ALL_PICKS = [
    ...
    ("Brady", "Xander Schauffele"),
    ("Lucas", "Joaquín Niemann"),
    ("Brock", "Ludvig Åberg"),
    ("Brock", "Justin Thomas"),
    ...
    ("Tom ", "Tommy Fleetwood"),
    ("Scott", "Sepp Straka"),
    ("David", "Viktor Hovland"),
    ("Sohale", "Keegan Bradley"),
    ("Sohale", "Tyrrell Hatton"),
    ("David", "Jordan Spieth"),
    ("Scott", "Aaron Rai"),
    ("Tom ", "Matt Fitzpatrick"),
    ("Jamil", "Harris English"),
    ("Brady", "Ben Griffin"),
    ("Lucas", "Russell Henley"),
    ("Brock", "Brooks Koepka"),
    ("Brock", "Justin Rose"),
    ("Lucas", "Sam Burns"),
    ("Brady", "Taylor Pendrith"),
    ("Jamil", "Hideki Matsuyama"),
    ("Tom ", "Patrick Reed"),
    ("Scott", "Cameron Young"),
    ("David", "Tony Finau"),
    ...
    ("Sohale", "J.J. Spaun"),
    ("David", "Nick Taylor"),
    ("Scott", "Maverick McNealy"),
    ("Tom ", "Sungjae Im"),
    ("Jamil", "Robert MacIntyre"),
    ("Brady", "Jason Day"),
    ("Lucas", "Akshay Bhatia"),
    ("Brock", "Si Woo Kim"),
    ("Brock", "Wyndham Clark"),
